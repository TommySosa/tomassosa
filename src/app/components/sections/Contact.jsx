        ...
        <section className="w-full max-w-6xl px-4 pb-40 mx-auto md:pb-0 md:px-6 text-white">
            <div className="container px-4 md:px-6">
                ...
                <form className="grid gap-4 max-w-md mx-auto mt-8" onSubmit={handleSubmit}>
                    <input
                        className="max-w-lg flex-1 rounded-md p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 text-black"
                    ...
                    <button
                        type="submit"
                        className="bg-[#03FE95] py-2 rounded-md"
                        aria-label="Enviar"
                        disabled={isSubmitting}
                    >
